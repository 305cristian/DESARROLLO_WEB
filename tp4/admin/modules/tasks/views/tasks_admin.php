  ...
  <section class="p-6 rounded-lg">
    <div class="flex justify-between items-center mb-4">
      ...
      <section>
        ...
        <a href="../../../../ajax/auth/loginout.php"><i class="fa-solid fa-right-from-bracket"></i>
